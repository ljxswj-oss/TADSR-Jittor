# 中文阅读说明：env_check_strict-cu118.md
...
# Official PyTorch Environment Check: strict-cu118

Status: **PASS**

Python: `/mnt/data/sj/venvs/tadsr_official_strict_cu118/bin/python`

| Package | Import | Critical | Expected | Actual | Status |
|---|---|---:|---|---|---|
| `torch` | `torch` | True | `2.0.1` | `2.0.1+cu118` | OK |
| `torchvision` | `torchvision` | True | `0.15.2` | `0.15.2+cu118` | OK |
