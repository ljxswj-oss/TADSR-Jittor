# 中文阅读说明：jittor_unet_entry_downblock0_downblock1_resnet0_attention0_resnet1_attention1_downsampler_alignment.md
...
# TADSR UNet Entry + DownBlock0 + DownBlock1 ResNet0 + Attention0 + ResNet1 + Attention1 + Downsampler Bridge Alignment
...
| downblock1_attention1_output | `3.4332275390625e-05` | `1.2935612232922721e-06` | `1.4181756053048228e-06` | `0.9999999999990887` | `0.002` |
| downblock1_downsampler_output | `2.2277235984802246e-05` | `2.579873682861944e-06` | `1.0776458816026287e-06` | `0.9999999999994817` | `0.002` |

Note: Local bridge stops after down_blocks.1.downsamplers.0. Full UNet is not executed.
