# 中文阅读说明：jittor_unet_manual_wrapper_alignment.md
...
# TADSR UNet Manual Full-Chain Wrapper Alignment
...
| manual_wrapper_output | `2.2277235984802246e-06` | `5.021606739319395e-07` | `5.980908879035516e-06` | `0.9999999999827354` | `0.002` |

Note: Alignment-only manual wrapper validates sample -> center -> conv_in -> time embedding -> down_blocks -> mid_block -> up_blocks.0/1/2/3 -> output tail. It does not call official UNet.forward, production Jittor forward, scheduler, VAE, runtime LoRA, or full inference.
