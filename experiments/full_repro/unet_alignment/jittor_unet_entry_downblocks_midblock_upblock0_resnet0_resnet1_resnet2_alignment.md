# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_resnet0_resnet1_resnet2_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 ResNet0 -> ResNet1 -> ResNet2 Bridge Alignment
...
| upblock0_resnet2_res_hidden | `3.0517578125e-05` | `3.670575767955597e-06` | `1.3387986697652404e-06` | `0.9999999999991991` | `0.002` |
| upblock0_resnet2_concat_input | `3.0517578125e-05` | `2.5581568479537966e-06` | `1.292221237989792e-06` | `0.9999999999992352` | `0.002` |
| upblock0_resnet2_output | `7.62939453125e-06` | `7.90000240158406e-07` | `1.3618544663611344e-06` | `0.9999999999992338` | `0.002` |

Note: Bridge stops exactly after up_blocks.0.resnets.2. Full up_blocks.0/up_blocks.0.upsampler/full UNet are not executed.
