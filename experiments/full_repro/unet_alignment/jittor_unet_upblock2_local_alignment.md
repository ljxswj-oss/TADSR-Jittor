# 中文阅读说明：jittor_unet_upblock2_local_alignment.md
...
# TADSR UNet up_blocks.2 Local Aggregate Alignment
...
Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> full local up_blocks.2 aggregate. It deliberately stops before up_blocks.3, full UNet forward, runtime LoRA, and full TADSR inference.
