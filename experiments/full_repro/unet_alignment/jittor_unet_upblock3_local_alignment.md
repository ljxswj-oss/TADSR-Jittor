# 中文阅读说明：jittor_unet_upblock3_local_alignment.md
...
# TADSR UNet up_blocks.3 Local Aggregate Alignment
...
| upblock3_attention1_output | `1.3113021850585938e-05` | `1.78809364257404e-06` | `1.7942187261774022e-06` | `0.9999999999983775` | `0.002` |
| upblock3_resnet2_output | `1.0311603546142578e-05` | `1.330868856541656e-06` | `1.5047459172632307e-06` | `0.9999999999988823` | `0.002` |
| upblock3_attention2_output | `2.288818359375e-05` | `2.3209084091035947e-06` | `1.265436949888023e-06` | `0.9999999999992443` | `0.002` |
| upblock3_output_hidden | `2.288818359375e-05` | `2.3209084091035947e-06` | `1.265436949888023e-06` | `0.9999999999992443` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> full local up_blocks.2 -> full local up_blocks.3 aggregate. It deliberately stops at the output-tail boundary and does not run conv_norm_out, conv_act, conv_out, full UNet forward, runtime LoRA, or full TADSR inference.
