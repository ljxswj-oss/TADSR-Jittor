# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblocks_output_tail_alignment.md
...
# TADSR UNet Entry Through Output Tail Alignment
...
| upblock3_output_hidden | `2.288818359375e-05` | `2.3209084091035947e-06` | `1.265436949888023e-06` | `0.9999999999992443` | `0.002` |
| output_tail_norm_output | `1.621246337890625e-05` | `3.1494222215284614e-07` | `7.719566529243264e-07` | `0.999999999999896` | `0.002` |
| output_tail_act_output | `2.473592758178711e-06` | `1.121274496231314e-07` | `1.6899209583211986e-06` | `0.9999999999982524` | `0.002` |
| output_tail_conv_out_output | `2.2277235984802246e-06` | `5.021606739319395e-07` | `5.980908879035516e-06` | `0.9999999999827354` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> full local up_blocks.2 -> full local up_blocks.3 -> output tail. It still does not call official UNet.forward, scheduler denoising, VAE integration, runtime LoRA, image postprocessing, or full TADSR inference.
