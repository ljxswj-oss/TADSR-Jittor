# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_resnet0_attention0_resnet1_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 ResNet0 -> Attention0 -> ResNet1 Bridge Alignment
...
Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> up_blocks.1.resnets.0 -> up_blocks.1.attentions.0 -> up_blocks.1.resnets.1 only. It still does not execute attention1, full up_blocks.1, or full UNet.
