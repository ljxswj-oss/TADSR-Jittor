# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_attention1_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 Resnet0 -> Attention0 -> Resnet1 -> Attention1 Bridge Alignment
...
| upblock2_attention1_input | `4.76837158203125e-05` | `3.435554700104149e-06` | `1.6651744839652864e-06` | `0.9999999999985997` | `0.002` |
| upblock2_attention1_output | `8.404254913330078e-05` | `4.292873563827016e-06` | `1.9911742782085947e-06` | `0.9999999999980967` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> up_blocks.2.resnets.0 -> up_blocks.2.attentions.0 -> up_blocks.2.resnets.1 -> up_blocks.2.attentions.1. It deliberately stops before up_blocks.2.resnets.2 and does not mark full up_blocks.2 complete.
