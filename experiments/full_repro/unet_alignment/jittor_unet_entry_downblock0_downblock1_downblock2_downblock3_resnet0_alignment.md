# 中文阅读说明：jittor_unet_entry_downblock0_downblock1_downblock2_downblock3_resnet0_alignment.md
...
# TADSR UNet Entry + DownBlock0 + DownBlock1 + DownBlock2 + DownBlock3 ResNet0 Bridge Alignment
...
Note: Local bridge: entry -> full down_blocks.0 -> full down_blocks.1 -> full down_blocks.2 -> down_blocks.3.resnets.0 only. Full down_blocks.3 and full UNet are not executed.
