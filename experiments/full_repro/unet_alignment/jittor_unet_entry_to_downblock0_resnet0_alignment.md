# 中文阅读说明：jittor_unet_entry_to_downblock0_resnet0_alignment.md
...
# TADSR UNet Entry to down_blocks.0.resnets.0 Alignment
...
Note: Stops before down_blocks.0.attentions.0.
