# 中文阅读说明：jittor_unet_entry_downblocks_midblock_resnet0_alignment.md
...
# TADSR UNet Entry + DownBlocks + MidBlock ResNet0 Bridge Alignment
...
Note: Local bridge: entry -> full local down_blocks.0/1/2/3 -> mid_block.resnets.0 only. Full mid_block/full UNet are not executed.
