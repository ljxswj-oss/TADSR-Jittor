# 中文阅读说明：jittor_unet_entry_downblock0_downblock1_resnet0_alignment.md
...
# TADSR UNet Entry + DownBlock0 + DownBlock1 ResNet0 Bridge Alignment
...
Note: Local bridge: entry -> full down_blocks.0 -> down_blocks.1.resnets.0 only. Full down_blocks.1 and full UNet are not executed.
