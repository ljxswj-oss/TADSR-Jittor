# 中文阅读说明：jittor_unet_entry_resnet0_attention0_alignment.md
...
# TADSR UNet Entry -> ResNet0 -> Attention0 Alignment
...
Note: Stops before resnets.1 / attentions.1 / downsampler.
