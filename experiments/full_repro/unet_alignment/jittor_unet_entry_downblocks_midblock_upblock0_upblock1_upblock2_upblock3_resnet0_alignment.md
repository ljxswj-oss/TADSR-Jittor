# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 -> UpBlock3 Resnet0 Bridge Alignment
...
| upblock3_resnet0_res_hidden | `6.67572021484375e-06` | `8.942489181151814e-07` | `1.4646243150770818e-06` | `0.9999999999990075` | `0.002` |
| upblock3_resnet0_concat_input | `8.535385131835938e-05` | `3.678062617140654e-06` | `2.122771003804693e-06` | `0.9999999999979458` | `0.002` |
| upblock3_resnet0_output | `1.6927719116210938e-05` | `2.550648282806378e-06` | `2.1855898085866294e-06` | `0.9999999999975839` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> full local up_blocks.2 -> up_blocks.3.resnets.0. It deliberately stops before up_blocks.3.attentions.0/resnets.1, full up_blocks.3, full UNet forward, runtime LoRA, and full TADSR inference.
