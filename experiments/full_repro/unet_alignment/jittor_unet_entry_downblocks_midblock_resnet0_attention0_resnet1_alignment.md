# 中文阅读说明：jittor_unet_entry_downblocks_midblock_resnet0_attention0_resnet1_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock ResNet0 -> Attention0 -> ResNet1 Bridge Alignment
...
| midblock_resnet1_output | `2.6702880859375e-05` | `3.800192098424304e-06` | `1.3949179221757381e-06` | `0.9999999999991097` | `0.002` |

Note: Bridge stops at mid_block.resnets.1. up_blocks/full UNet are not executed.
