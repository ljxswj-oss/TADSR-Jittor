# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 Resnet0 Bridge Alignment
...
| upblock2_resnet0_res_hidden | `3.4332275390625e-05` | `1.2935612232922721e-06` | `1.4181756053048228e-06` | `0.9999999999990887` | `0.0001` |
| upblock2_resnet0_concat_input | `8.705258369445801e-05` | `5.694831150767262e-06` | `1.8431713206182937e-06` | `0.9999999999983171` | `0.0001` |
| upblock2_resnet0_output | `5.8650970458984375e-05` | `5.473751028262086e-06` | `1.7031394906329906e-06` | `0.999999999998551` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> up_blocks.2.resnets.0. It deliberately stops before up_blocks.2.attentions.0 and does not mark full up_blocks.2 complete.
