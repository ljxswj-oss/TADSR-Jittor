# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 Resnet0 -> Attention0 -> Resnet1 Bridge Alignment
...
| upblock2_resnet1_hidden_input | `0.00016689300537109375` | `5.791685134681757e-06` | `1.8198575843490394e-06` | `0.9999999999983219` | `0.002` |
| upblock2_resnet1_res_hidden | `1.329183578491211e-05` | `1.3588772276307282e-06` | `1.2827697305785698e-06` | `0.9999999999991661` | `0.002` |
| upblock2_resnet1_concat_input | `0.00016689300537109375` | `3.5752811811562426e-06` | `1.685728122614959e-06` | `0.9999999999984049` | `0.002` |
| upblock2_resnet1_output | `4.76837158203125e-05` | `3.435554700104149e-06` | `1.6651744839652864e-06` | `0.9999999999985997` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> up_blocks.2.resnets.0 -> up_blocks.2.attentions.0 -> up_blocks.2.resnets.1. It deliberately stops before up_blocks.2.attentions.1 and does not mark full up_blocks.2 complete.
