# 中文阅读说明：jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_attention0_alignment.md
...
# TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 -> UpBlock3 Resnet0 -> Attention0 Bridge Alignment
...
| upblock3_attention0_input | `1.6927719116210938e-05` | `2.550648282806378e-06` | `2.1855898085866294e-06` | `0.9999999999975839` | `0.002` |
| upblock3_attention0_output | `2.2172927856445312e-05` | `3.021396412350441e-06` | `2.1506846311867753e-06` | `0.9999999999977839` | `0.002` |

Note: Bridge validates entry -> all down_blocks -> full local mid_block -> full local up_blocks.0 -> full local up_blocks.1 -> full local up_blocks.2 -> up_blocks.3.resnets.0 -> up_blocks.3.attentions.0. It deliberately stops before up_blocks.3.resnets.1 and does not mark full up_blocks.3 complete.
