# 中文阅读说明：jittor_encoder_to_decoder_upblock3_alignment.md
...
# TimeAware VAE Encoder To Decoder UpBlock3 Alignment
...
| shape_match | `True` |
| shape | `[1, 128, 32, 32]` |
| max_abs_error | `0.0001983642578125` |
| mean_abs_error | `1.1409385308525088e-05` |
| relative_error | `4.127181599072453e-07` |
| cosine_similarity | `0.9999999999999254` |
| tolerance | `0.001` |
...
| decoder_upblock2 | `0.0001678466796875` | `1.3979698969102117e-05` | `6.356757399590799e-07` | `0.9999999999998602` |
| decoder_upblock3 | `0.0001983642578125` | `1.1409385308525088e-05` | `4.127181599072453e-07` | `0.9999999999999254` |

Note: deterministic full bridge through encoder and partial decoder, ending at decoder.up_blocks.3; decoder tail is still out of scope
