# 中文阅读说明：jittor_quant_to_decoder_upblock1_alignment.md
...
# TimeAware VAE Quant To Decoder UpBlock1 Alignment
...
| shape_match | `True` |
| shape | `[1, 512, 16, 16]` |
| max_abs_error | `6.866455078125e-05` |
| mean_abs_error | `7.4422425981879314e-06` |
| relative_error | `5.452115853200274e-07` |
| cosine_similarity | `0.9999999999998994` |
| tolerance | `0.0001` |
