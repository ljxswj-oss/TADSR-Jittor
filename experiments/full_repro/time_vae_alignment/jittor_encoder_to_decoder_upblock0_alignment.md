# 中文阅读说明：jittor_encoder_to_decoder_upblock0_alignment.md
...
# TimeAware VAE Encoder To Decoder UpBlock0 Alignment
...
| shape_match | `True` |
| shape | `[1, 512, 8, 8]` |
| max_abs_error | `2.288818359375e-05` |
| mean_abs_error | `2.426172670766391e-06` |
| relative_error | `5.853031475402665e-07` |
| cosine_similarity | `0.9999999999998798` |
| tolerance | `0.0001` |
