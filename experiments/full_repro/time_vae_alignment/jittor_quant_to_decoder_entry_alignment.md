# 中文阅读说明：jittor_quant_to_decoder_entry_alignment.md
...
# TimeAware VAE Quant To Decoder Entry Alignment
...
| mean_abs_error | `9.555520819048979e-08` |
| relative_error | `9.694945281911466e-08` |
| cosine_similarity | `0.9999999999999947` |
| tolerance | `0.0001` |
...
Note: real encoder moments oracle; no latent sampling
