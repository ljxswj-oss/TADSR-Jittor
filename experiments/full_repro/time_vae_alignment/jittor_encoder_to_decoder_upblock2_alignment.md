# 中文阅读说明：jittor_encoder_to_decoder_upblock2_alignment.md
...
# TimeAware VAE Encoder To Decoder UpBlock2 Alignment
...
| mean_abs_error | `1.3979698969102117e-05` |
| relative_error | `6.356757399590799e-07` |
| cosine_similarity | `0.9999999999998602` |
| tolerance | `0.001` |
...
Note: deterministic full bridge through encoder and partial decoder, ending at decoder.up_blocks.2; full decoder still excludes upblock3 and tail
