# 中文阅读说明：jittor_encoder_to_decoder_midblock_alignment.md
...
# TimeAware VAE Encoder To Decoder MidBlock Alignment
...
| shape_match | `True` |
| shape | `[1, 512, 4, 4]` |
| max_abs_error | `4.500150680541992e-06` |
| mean_abs_error | `6.389774540593862e-07` |
| relative_error | `5.408308145189686e-07` |
| cosine_similarity | `0.9999999999998869` |
| tolerance | `0.0001` |
