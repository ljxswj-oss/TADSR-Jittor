# 中文阅读说明：time_vae_midblock_hook_report.md
...
# TimeAware VAE MidBlock Oracle Export

Status: **PASS**

Input shape: `[1, 3, 32, 32]`
Timestep: `50`
Attention exists: `True`
...
| `encoder.mid_block.attentions.0` | `Attention` | `[1, 512, 4, 4]` | `[1, 512, 4, 4]` | PASS |
| `encoder.mid_block.resnets.1` | `ResnetBlock2D` | `[1, 512, 4, 4], temb=[1, 256]` | `[1, 512, 4, 4]` | PASS |
...
| `encoder.mid_block.resnets.0` | `ResnetBlock2D` | `[1, 512, 4, 4], temb=[1, 256]` | `[1, 512, 4, 4]` | PASS |
