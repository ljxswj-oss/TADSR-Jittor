# 中文阅读说明：jittor_decoder_entry_midblock_upblocks0123_alignment.md
...
# TimeAware VAE Decoder Entry+MidBlock+UpBlocks0-3 Alignment
...
| shape_match | `True` |
| shape | `[1, 128, 32, 32]` |
| max_abs_error | `0.00128173828125` |
| mean_abs_error | `4.334792453164482e-05` |
| relative_error | `1.9956227696869127e-06` |
| cosine_similarity | `0.9999999999963466` |
| tolerance | `0.002` |
...
| decoder_upblock3 | `0.00128173828125` | `4.334792453164482e-05` | `1.9956227696869127e-06` | `0.9999999999963466` |
