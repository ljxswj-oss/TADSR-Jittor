...
| Metric | Value |
|---|---:|
| Relative L2 diff | 2.30811322e-03 |
| MAE | 1.44854176e-04 |
| Max abs diff | 5.20363450e-04 |
| Cosine similarity | 0.99999750 |

## Loss-Curve Alignment

| Metric | Value |
|---|---:|
| Final train relative gap | 1.03540031e-02 |
| Final validation relative gap | 3.71002037e-03 |
| Train loss correlation | 0.99995428 |
| Validation loss correlation | 0.99997667 |
