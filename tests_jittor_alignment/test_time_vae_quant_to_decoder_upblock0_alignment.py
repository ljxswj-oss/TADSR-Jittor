...
def main() -> int:
    ...
    if blocked:
        ...
        got = tester.run_quant_to_decoder_upblock0(oracle['real_moments'], None, return_intermediates=True)
        diagnostics = {
        ...
        result = {
            ...
            'target': 'quant_conv moments -> posterior mode -> post_quant_conv -> decoder.conv_in -> decoder.mid_block -> decoder.up_blocks.0',
    ...
    write_report('jittor_quant_to_decoder_upblock0_alignment', 'TimeAware VAE Quant Moments To Decoder UpBlock0 Alignment', result)
    print(f"TIME_VAE_QUANT_TO_DECODER_UPBLOCK0_ALIGNMENT: {result['status']}")
