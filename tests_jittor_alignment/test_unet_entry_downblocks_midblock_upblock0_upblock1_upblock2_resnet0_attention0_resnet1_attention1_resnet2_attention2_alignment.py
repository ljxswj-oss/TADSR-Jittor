...
from unet_upblock2_attention2_common import (
    add_metrics,
    blocked_result,
    bridge_tester,
    load_oracle,
...
def main() -> int:
    ...
    name = 'jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_attention1_resnet2_attention2_alignment'
    title = 'TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 Resnet0 -> Attention0 -> Resnet1 -> Attention1 -> Resnet2 -> Attention2 Bridge Alignment'
    marker = 'TADSR_UNET_ENTRY_DOWNBLOCKS_MIDBLOCK_UPBLOCK0_UPBLOCK1_UPBLOCK2_RESNET0_ATTENTION0_RESNET1_ATTENTION1_RESNET2_ATTENTION2_ALIGNMENT'
    if blocked:
    ...
    got = tester.run_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_attention1_resnet2_attention2(
    ...
    expected = {
        ...
        'upblock2_attention2_input': 'entry_upblock2_attention2_input',
    ...
    result = {
        ...
        'note': (
            ...
            'up_blocks.2.attentions.2. It deliberately stops before '
            'up_blocks.2.upsamplers.0 and does not mark full up_blocks.2 complete.'
        ),
    }
