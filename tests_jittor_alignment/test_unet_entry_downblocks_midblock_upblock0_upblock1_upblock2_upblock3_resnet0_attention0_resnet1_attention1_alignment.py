...
def main() -> int:
    ...
    name = 'jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_attention0_resnet1_attention1_alignment'
    title = 'TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 -> UpBlock3 Resnet0 -> Attention0 -> Resnet1 -> Attention1 Bridge Alignment'
    marker = 'TADSR_UNET_ENTRY_DOWNBLOCKS_MIDBLOCK_UPBLOCK0_UPBLOCK1_UPBLOCK2_UPBLOCK3_RESNET0_ATTENTION0_RESNET1_ATTENTION1_ALIGNMENT'
    if blocked:
    ...
    got = tester.run_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_attention0_resnet1_attention1(
    ...
    expected = {
        ...
        'upblock3_attention1_input': 'entry_upblock3_attention1_input',
    ...
    result = {
        ...
        'note': (
            ...
            'full local up_blocks.0 -> full local up_blocks.1 -> full local '
            'up_blocks.2 -> up_blocks.3.resnets.0 -> up_blocks.3.attentions.0 -> '
            'up_blocks.3.resnets.1 -> up_blocks.3.attentions.1. It deliberately '
            'stops before up_blocks.3.resnets.2 and does not mark full up_blocks.3 complete.'
        ),
    }
