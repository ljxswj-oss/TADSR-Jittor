...
def main() -> int:
    ...
    name = 'jittor_unet_upblock1_local_alignment'
    title = 'TADSR UNet up_blocks.1 Local Aggregate Alignment'
    if blocked:
        result = blocked_result(name, title, blocked)
        print('TADSR_UNET_UPBLOCK1_OUTPUT_HIDDEN_ALIGNMENT:', result['status'])
        print('TADSR_UNET_UPBLOCK1_OUTPUT_STATES_ALIGNMENT:', result['status'])
        print('TADSR_UNET_UPBLOCK1_ALIGNMENT:', result['status'])
        return 0 if result['status'] == 'PASS' else 1
    tester = local_tester()
    got = tester.run_entry_downblocks_midblock_upblock0_upblock1_local(
    ...
    expected = {
        ...
        'upblock1_resnet0_output': 'manual_upblock1_resnet0_output',
        'upblock1_attention0_output': 'manual_upblock1_attention0_output',
        'upblock1_resnet1_output': 'manual_upblock1_resnet1_output',
        'upblock1_attention1_output': 'manual_upblock1_attention1_output',
        'upblock1_resnet2_output': 'manual_upblock1_resnet2_output',
        'upblock1_attention2_output': 'manual_upblock1_attention2_output',
        'upblock1_upsampler_output': 'manual_upblock1_upsampler_output',
        'upblock1_output_hidden': 'local_upblock1_hidden_states_output',
    }
    diag = {}
    ...
    hidden_status = status_from_metrics(diag['upblock1_output_hidden'])
    ...
    result = {
        ...
        'note': (
            ...
            '-> full local up_blocks.1 aggregate. It deliberately stops before up_blocks.2 and full UNet.'
        ),
    }
    write_report(name, title, result)
    print('TADSR_UNET_UPBLOCK1_OUTPUT_HIDDEN_ALIGNMENT:', hidden_status)
    print('TADSR_UNET_UPBLOCK1_OUTPUT_STATES_ALIGNMENT:', output_states_status)
    print('TADSR_UNET_UPBLOCK1_ALIGNMENT:', status)
