...
def main() -> int:
    ...
    name = 'jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_attention0_resnet1_alignment'
    title = 'TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 -> UpBlock3 Resnet0 -> Attention0 -> Resnet1 Bridge Alignment'
    marker = 'TADSR_UNET_ENTRY_DOWNBLOCKS_MIDBLOCK_UPBLOCK0_UPBLOCK1_UPBLOCK2_UPBLOCK3_RESNET0_ATTENTION0_RESNET1_ALIGNMENT'
    if blocked:
    ...
    got = tester.run_entry_downblocks_midblock_upblock0_upblock1_upblock2_upblock3_resnet0_attention0_resnet1(
    ...
    expected = {
        ...
        'upblock3_resnet1_res_hidden': 'entry_upblock3_resnet1_res_hidden',
        'upblock3_resnet1_concat_input': 'entry_upblock3_resnet1_concat_input',
    ...
    result = {
        ...
        'note': (
            ...
            'up_blocks.3.resnets.1. It deliberately stops before up_blocks.3.attentions.1 '
            'and does not mark full up_blocks.3 complete.'
        ),
    }
