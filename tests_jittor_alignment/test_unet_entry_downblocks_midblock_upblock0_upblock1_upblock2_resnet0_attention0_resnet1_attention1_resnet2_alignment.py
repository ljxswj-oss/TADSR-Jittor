...
def main() -> int:
    ...
    name = 'jittor_unet_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_attention1_resnet2_alignment'
    title = 'TADSR UNet Entry -> DownBlocks -> MidBlock -> UpBlock0 -> UpBlock1 -> UpBlock2 Resnet0 -> Attention0 -> Resnet1 -> Attention1 -> Resnet2 Bridge Alignment'
    if blocked:
        result = blocked_result(name, title, blocked)
        print('TADSR_UNET_ENTRY_DOWNBLOCKS_MIDBLOCK_UPBLOCK0_UPBLOCK1_UPBLOCK2_RESNET0_ATTENTION0_RESNET1_ATTENTION1_RESNET2_ALIGNMENT:', result['status'])
        return 0 if result['status'] == 'PASS' else 1

    tester = bridge_tester()
    got = tester.run_entry_downblocks_midblock_upblock0_upblock1_upblock2_resnet0_attention0_resnet1_attention1_resnet2(
    ...
    expected = {
        ...
        'upblock2_resnet2_hidden_input': 'entry_upblock2_resnet2_hidden_input',
        'upblock2_resnet2_res_hidden': 'entry_upblock2_resnet2_res_hidden',
        'upblock2_resnet2_concat_input': 'entry_upblock2_resnet2_concat_input',
    ...
    result = {
        ...
        'note': (
            ...
            'up_blocks.2.attentions.1 -> up_blocks.2.resnets.2. It deliberately '
            'stops before up_blocks.2.attentions.2 and does not mark full up_blocks.2 complete.'
        ),
    }
    write_report(name, title, result)
    print('TADSR_UNET_ENTRY_DOWNBLOCKS_MIDBLOCK_UPBLOCK0_UPBLOCK1_UPBLOCK2_RESNET0_ATTENTION0_RESNET1_ATTENTION1_RESNET2_ALIGNMENT:', status)
